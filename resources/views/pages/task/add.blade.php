                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('task.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control {{ $errors->has('name') ? "is-invalid":"" }}" placeholder="Task name" value="{{ old('name') }}">
                                @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="start" class="form-control datetimepicker {{ $errors->has('start') ? "is-invalid":"" }}" value="{{ old('start') }}">
                                @if($errors->has('start'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="end" class="form-control  datetimepicker  {{ $errors->has('end') ? "is-invalid":"" }}" value="{{ old('end') }}">
                                @if($errors->has('end'))
