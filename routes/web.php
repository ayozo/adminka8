...
Route::group(['middleware' => 'auth'],function (){
    ...
    Route::group(['prefix' => 'task'], function (){
        ...
        Route::get('/edit/{task_id}', [TaskController::class,'edit'])->name('task.edit');
        Route::post('/update/{task_id}', [TaskController::class,'update'])->name('task.update');
        Route::get('/show/{task_id}', [TaskController::class,'show'])->name('task.show');
        Route::get('/delete/{task_id}', [TaskController::class,'delete'])->name('task.delete');
        Route::get('/started/{task_id}', [TaskController::class,'started'])->name('task.started');
        Route::get('/ended/{task_id}', [TaskController::class,'ended'])->name('task.ended');
//        Route::get('/ended/{task_id}', [TaskController::class,'delete'])->name('task.delete');
    });
